...
def draw_community(gml_fn, output,
    ...
    v_size = prop_to_size(g.vp['wdeg'], mi=MIN_V_SIZE, ma=MAX_V_SIZE,
            log=V_SIZE_LOG, power=V_SIZE_POWER)
    e_width = prop_to_size(g.ep['weight'], mi=MIN_E_WIDTH, ma=MAX_E_WIDTH,
            log=E_WIDTH_LOG, power=E_WIDTH_POWER)
